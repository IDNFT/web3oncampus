...
import FeaturesBg from '@/public/illustration/Community.svg'
...
import Web3CampusDocs from '@/public/illustration/web3-campus-docs.png'
import TemuNftDocs from '@/public/illustration/temu-nft-docs.png'
        ...
        <div className="pt-12 md:pt-20">
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-0" data-aos="fade-right">
              <div className="md:pr-0 lg:pr-0 xl:pr-0 mb-0">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1">
              <div className="transition-all">
                <div className="relative flex flex-col text-center lg:text-right" data-aos="zoom-y-out" ref={tabs}>
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <Image className="md:max-w-none mx-auto rounded" src={Web3CampusDocs} width={500} height="462" alt="Web3 On Campus Docs" />
                    </div>
                  </Transition>
                  {/* Item 3 */}
                  <Transition
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <Image className="md:max-w-none mx-auto rounded" src={TemuNftDocs} width={500} height="462" alt="Temu NFT Docs" />
                    </div>
                  </Transition>
                </div>
              </div>
